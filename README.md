...
1. Making changes to the [guide to WCAG on Github](https://github.com/alphagov/guide-to-wcag). To contribute to this repository, you first need to [fork it](https://help.github.com/en/articles/fork-a-repo). You can raise pull requests from your forked copy.
